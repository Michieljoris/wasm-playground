...
export_wasm Mempool* create_mempool(int slot_size, uint slot_clount, int auto_resize, Log log) {
...
export_wasm void* mempool_alloc(Mempool* mempool) {
  // Resizing
...
export_wasm void mempool_free(Mempool* mempool, void* slot) {
